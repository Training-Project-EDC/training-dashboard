...
class DashboardView(DashboardViewMixin, EdcBaseViewMixin, SubjectDashboardViewMixin,
    ...
    subject_locator_model = 'training_subject.personalcontactinfo'
    subject_locator_model_wrapper_cls = ContactInformationModelWrapper
    special_forms_include_value = "training_dashboard/subject/dashboard/special_forms.html"
    navbar_name = 'training_dashboard'
